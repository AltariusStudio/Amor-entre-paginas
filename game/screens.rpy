...
screen about():
    ...
    use game_menu(_("Creditos"), scroll="viewport"):
        ...
        vbox:
            text "{font=Fuentes/CormorantGaramond-BoldItalic.ttf}{size=130}{color=#9A05BF}Creador{/color}{/size}{/font}"
            null height 30
        ...
        hbox:
            ...
            vbox:
                null height 10
                text "{font=Fuentes/CormorantGaramond-BoldItalic.ttf}{size=90}{color=#fafa62}Altarius{/color}{/size}{/font}"
                null height 10
                text "{font=Fuentes/CormorantGaramond-BoldItalic.ttf}{size=70}Arte, historia y pogramación{/size}{/font}" 
                null height 30
                hbox:
                    text "{font=Fuentes/CormorantGaramond-BoldItalic.ttf}{color=#AE31FD}{size=70}{u}Redes sociales:{/u}{/color}{/size}{/font}"
                    spacing 20
                    text ("{a=https://altariusstudio.itch.io/}itch_io{/a}")
                    
                    text ("{a=https://www.youtube.com/@AltariusStudio}Youtube{/a}")
                    
                    text ("{a=https://www.instagram.com/altariusstudio/}Instagram{/a}")                    
                    
                    text ("{a=https://www.wattpad.com/user/AltariusStudio}Wattpad{/a}")
                    
                    text ("{a=https://www.patreon.com/AltariusStudio}Patreon{/a}")
                    
                    text ("{a=https://x.com/AltariusStudio}x(Twitter){/a}")


        vbox:
            null height 30
            text "Aquí encontraras los creditos a los programas, recursos y codigo usados para hacer este juego."
            null height 20
            text "{u}Programas{/u}" 
            null height 30
            text ("{a=https://koikatsuparty.illusion.rip/}Koikatsu party{/a} de {a=https://illusion.rip/index2.html}Illusion{/a} Programa usado para la creación de los personajes.")
            spacing 20
            text ("{a=https://old.illusion.rip/preview/charastudio/index.php}Chara Studio{/a} de {a=https://illusion.rip/index2.html}Illusion{/a} Programa usado para la creación de las escenas y la creación de los escenarios.")
            text ("{a=https://www.canva.com/}Canva{/a} Programa usado para el ajuste de imagenes y creación de la imagen del inicio del juego.")
            null height 30
            text "{u}Recursos{/u}"
            null height 20
            text "{a=https://directory.audio/es/}directory.audio{/a} de donde saque los efectos de sonido y música"
            text "Este juego contiene Nueva notificación nº 7 licenciado bajo una licencia Creative Commons Attribution. Fuente: {a=https://directory.audio/es/efectos-de-sonido/interfaz-ui/34654-nueva-notificacion-no-7}directory.audio{/a} Autor: {a=https://directory.audio/es/authoritems/79915-universfield}UNIVERSFIELD{/a}"
            text "Este juego contiene Pista de música UNIVERSFIELD - Floating Piano Melodies licenciado bajo una licencia Creative Commons Attribution. Fuente: {a=https://directory.audio/es/musica-gratis/ambiente/33987-universfield-floating-piano-melodies}directory.audio{/a} Autor: {a=https://directory.audio/es/authoritems/79915-universfield}UNIVERSFIELD{/a}"
            text "Este trabajo contiene Pista de música Zaxavar Beats - Behind the Stars licenciado bajo una licencia Creative Commons Attribution. Fuente: {a=https://directory.audio/es/musica-gratis/baile-y-electronica/34699-zaxavar-beats-behind-the-stars}directory.audio{/a} Autor: {a=https://directory.audio/es/authoritems/695-zaxavar}Zaxavar{/a}"
            text ("{a=https://www.pixiv.net/en/artworks/93188206}KK Dokis Cards{/a} de {a=https://www.pixiv.net/en/users/47209917}Ecxreaper{/a} De aquí saque las tarjetas de los modelis de las Dokis")
            null height 30
            text "{u}Codigo{/u}"
            null height 30
            text ("{a=https://gaming-variety-potato.itch.io/renpy-credits-screen-ui-templates}Credits screen templates{/a} de {a=https://gaming-variety-potato.itch.io/}Gaming variety potato{/a} Codigo e estilo que me ayudo a agregar la parte de los roles, lo use en un principio pero tras unos cambios tuve que quitarlo. Igual doy el credito ya que me fue de mucha ayuda.")
            null height 30
            text "{u}Inspiración{/u}"
            text "Aquí veran lo que use o me inspiro a hacer este juego"
            null height 20
            text ("{a=https://ddlc.moe/}Doki Doki Literature CLub{/a} de {a=https://teamsalvato.com/}Team Salvato{/a} Juego en que se basa este juego para su historia.")
            
            text ("{a=https://onioncuttingninja.itch.io/total-maidness}Total Maidness{/a} de {a=https://onioncuttingninja.itch.io/}Onioncuttingninja{/a} Juego que me sirvio para la parte de interfas, interación y gracias al mismo conoci Koikatsu party. Este juego es para adultos así que ten cuidado al hacer click en el nombre del juego")
