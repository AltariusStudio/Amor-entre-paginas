...
define config.mouse = {"default": [("gui/A.png", 0, 0)]}
...
define config.name = _("Amor entre paginas")
...
define build.name = "Amorentrepaginas"
...
define config.main_menu_music = "Floating Piano Melodies.mp3"
...
define config.save_directory = "Amorentrepaginas-1723656266"
